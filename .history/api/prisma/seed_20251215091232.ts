...
async function main() {
  ...
  const permissions = [
    ...
    // Permissions Accueil
    { key: 'm.read', description: 'Consulter les pages d\'m' },
    { key: 'm.create', description: 'Créer des pages d\'m' },
    { key: 'm.update', description: 'Modifier les pages d\'m' },
    { key: 'm.delete', description: 'Supprimer des pages d\'m' },
