...
async function main() {
  ...
  const permissions = [
    ...
    // Permissions Accueil
    { key: 'messa.read', description: 'Consulter les pages d\'messa' },
    { key: 'messa.create', description: 'Créer des pages d\'messa' },
    { key: 'messa.update', description: 'Modifier les pages d\'messa' },
    { key: 'messa.delete', description: 'Supprimer des pages d\'messa' },
