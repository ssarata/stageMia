...
async function main() {
  ...
  const permissions = [
    ...
    // Permissions Accueil
    { key: 'messageHistorique.read', description: 'Consulter les pages d\'messageHistorique' },
    { key: 'messageHistorique.create', description: 'Créer des pages d\'messageHistorique' },
    { key: 'messageHistorique.update', description: 'Modifier les pages d\'messageHistorique' },
    { key: 'messageHistorique.delete', description: 'Supprimer des pages d\'messageHistorique' },
