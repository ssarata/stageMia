...
async function main() {
  ...
  const permissions = [
    ...
    { nomPermission: 'VIEW_contacS', description: 'Voir toutes les contacs' },
    { nomcontac: 'CREATE_contac', description: 'Créer une contac' },
    { nomcontac: 'UPDATE_contac', description: 'Modifier une contac' },
    { nomcontac: 'DELETE_contac', description: 'Supprimer une contac' },
