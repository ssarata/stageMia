...
async function main() {
  ...
  const permissions = [
    ...
    { nomcategorie: 'CREATE_categorie', description: 'Créer une categorie' },
    { nomcategorie: 'UPDATE_categorie', description: 'Modifier une categorie' },
    { nomcategorie: 'DELETE_categorie', description: 'Supprimer une categorie' },
