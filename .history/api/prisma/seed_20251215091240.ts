...
async function main() {
  ...
  const permissions = [
    ...
    // Permissions Accueil
    { key: 'messageHisto.read', description: 'Consulter les pages d\'messageHisto' },
    { key: 'messageHisto.create', description: 'Créer des pages d\'messageHisto' },
    { key: 'messageHisto.update', description: 'Modifier les pages d\'messageHisto' },
    { key: 'messageHisto.delete', description: 'Supprimer des pages d\'messageHisto' },
