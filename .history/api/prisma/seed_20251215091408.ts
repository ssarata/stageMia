...
async function main() {
  ...
  const permissions = [
    ...
    { key: 'SharedContact.read', description: 'Consulter les pages d\'SharedContact' },
    { key: 'SharedContact.create', description: 'Créer des pages d\'SharedContact' },
    { key: 'SharedContact.update', description: 'Modifier les pages d\'SharedContact' },
    { key: 'SharedContact.delete', description: 'Supprimer des pages d\'SharedContact' },
