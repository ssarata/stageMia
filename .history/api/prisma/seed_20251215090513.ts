...
async function main() {
  ...
  const permissions = [
    ...
    { nomPermission: 'VIEW_caS', description: 'Voir toutes les cas' },
    { nomca: 'CREATE_ca', description: 'Créer une ca' },
    { nomca: 'UPDATE_ca', description: 'Modifier une ca' },
    { nomca: 'DELETE_ca', description: 'Supprimer une ca' },
