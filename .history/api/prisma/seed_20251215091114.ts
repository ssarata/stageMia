...
async function main() {
  ...
  const permissions = [
    ...
    // Permissions Élèves
    { key: 'categorie.read', description: 'Consulter les élèves' },
    { key: 'categorie.create', description: 'Inscrire des élèves' },
    { key: 'categorie.update', description: 'Modifier les informations des élèves' },
    { key: 'categorie.delete', description: 'Supprimer des élèves' },
