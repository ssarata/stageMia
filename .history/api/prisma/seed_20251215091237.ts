...
async function main() {
  ...
  const permissions = [
    ...
    // Permissions Accueil
    { key: 'messageH.read', description: 'Consulter les pages d\'messageH' },
    { key: 'messageH.create', description: 'Créer des pages d\'messageH' },
    { key: 'messageH.update', description: 'Modifier les pages d\'messageH' },
    { key: 'messageH.delete', description: 'Supprimer des pages d\'messageH' },
