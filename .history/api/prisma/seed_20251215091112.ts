...
async function main() {
  ...
  const permissions = [
    ...
    // Permissions Élèves
    { key: 'cate.read', description: 'Consulter les élèves' },
    { key: 'cate.create', description: 'Inscrire des élèves' },
    { key: 'cate.update', description: 'Modifier les informations des élèves' },
    { key: 'cate.delete', description: 'Supprimer des élèves' },
