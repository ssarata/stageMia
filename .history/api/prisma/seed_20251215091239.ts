...
async function main() {
  ...
  const permissions = [
    ...
    // Permissions Accueil
    { key: 'messageHis.read', description: 'Consulter les pages d\'messageHis' },
    { key: 'messageHis.create', description: 'Créer des pages d\'messageHis' },
    { key: 'messageHis.update', description: 'Modifier les pages d\'messageHis' },
    { key: 'messageHis.delete', description: 'Supprimer des pages d\'messageHis' },
