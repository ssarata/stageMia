...
async function main() {
  ...
  const permissions = [
    ...
    { nomPermission: 'VIEW_conS', description: 'Voir toutes les cons' },
    { nomcon: 'CREATE_con', description: 'Créer une con' },
    { nomcon: 'UPDATE_con', description: 'Modifier une con' },
    { nomcon: 'DELETE_con', description: 'Supprimer une con' },
