...
// Temporary: log queries to help diagnose schema/DB mismatches
prisma.$on('query', (e) => {
...
async function main() {
  ...
  const roles = [
    ...
    { name: 'PROVISEUR', description: 'Proviseur - Gestion complète de l\'établissement' },
    { name: 'PROFESSEUR', description: 'Professeur - gestion pédagogique et notes' },
    { name: 'ECONOME', description: 'Économe - gestion financière et inscriptions' },
    { name: 'SURVEILLANT', description: 'Surveillant - discipline et présence' },
    { name: 'SECRETAIRE', description: 'Secrétaire - gestion administrative limitée' },
    { name: 'PARENT', description: 'Parent d\'élève - consultation de son enfant' },
    { name: 'ELEVE', description: 'Élève - consultation de ses propres données' }
  ];
