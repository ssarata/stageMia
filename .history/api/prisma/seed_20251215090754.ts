...
async function main() {
  ...
  const permissions = [
    ...
    { nomPermission: 'CREATE_contact', description: 'Créer une contact' },
    { nomPermission: 'UPDATE_contact', description: 'Modifier une contact' },
    { nomPermission: 'DELETE_contact', description: 'Supprimer une contact' },

    { nomPermission: 'VIEW_categorieS', description: 'Voir toutes les categories' },
    { nomPermission: 'CREATE_categorie', description: 'Créer une categorie' },
    { nomPermission: 'UPDATE_categorie', description: 'Modifier une categorie' },
    { nomPermission: 'DELETE_categorie', description: 'Supprimer une categorie' },
  ...
  const userRole = await prisma.role.upsert({
   ...
   const userL = await prisma.role.upsert({
    where: { nomRole: 'User' },
    update: {},
    create: {
      nomRole: 'User',
