...
async function main() {
  ...
  const permissions = [
    ...
    // Permissions Accueil
    { key: 'messageHistorique.read', description: 'Consulter les pages messageHistorique' },
    { key: 'messageHistorique.create', description: 'Créer des pages messageHistorique' },
    { key: 'messageHistorique.update', description: 'Modifier les pages messageHistorique' },
    { key: 'messageHistorique.delete', description: 'Supprimer des pages messageHistorique' },
