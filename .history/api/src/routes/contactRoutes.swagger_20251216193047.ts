 ...
 *         description: Erreur serveur
 */
router.post('/', authenticate, validatePhone({ field: 'telephone', required: true }), createContact);
 ...
 *         description: Non authentifié
 */
router.put('/:id', authenticate, validatePhone({ field: 'telephone', required: false }), updateContact);
