...
export default function LoginForm({
  ...
  return (
    <div className="relative w-full max-w-sm">
      ...
      <div className="absolute -top-4 -right-4 w-16 h-16 bg-green-100 rounded-full blur-xl opacity-40"></div>
      <div className="absolute -bottom-3 -left-3 w-14 h-14 bg-emerald-100 rounded-full blur-xl opacity-30"></div>
      
      <Card className="relative z-10 border border-gray-200 shadow-xl bg-white/95 backdrop-blur-sm">
        {/* Bande décorative */}
        <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-green-400 to-emerald-500"></div>
        
        <CardHeader className="text-center pb-1 pt-4">
          <div className="mx-auto w-10 h-10 bg-gradient-to-br from-green-500 to-emerald-600 rounded-full flex items-center justify-center mb-2 shadow-sm">
            <KeyRound className="w-4 h-4 text-white" />
          </div>
          
          <CardTitle className="text-lg font-bold bg-gradient-to-r from-green-600 to-emerald-700 bg-clip-text text-transparent">
            Connexion
          </CardTitle>
        </CardHeader>
        ...
        <CardContent className="space-y-3 pb-4">
          ...
          <div className="space-y-2 text-center pt-1">
            <div className="flex justify-between items-center text-xs">
              ...
              <Link 
                to="/auth/register"
                className="group flex items-center gap-1 text-green-700 hover:text-green-800 font-medium transition-all"
              >
